...
r = run(f"{S}/award/scripts/citation_check.py", t.name, "--level", "NA"); res.append(("award over-limit", r.returncode == 1 and "limit 1250" in r.stdout and "capital" in r.stdout)); os.unlink(t.name)
