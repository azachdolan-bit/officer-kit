...
4. **Then (Path E):** checkers as blocking hooks (unknown 2); pack selection from the rules file; the blind test in a fresh session; `share-method` and the marketplace question; `njp-package` once an SJA reviewed exemplar exists.
