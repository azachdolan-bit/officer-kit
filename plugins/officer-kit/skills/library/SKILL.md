...
|---|---|---|---|
| **0. Starter library zip** (fastest) | everyone | 2 minutes | Download `Officer-Kit-Starter-Library.zip` (https://github.com/azachdolan-bit/officer-kit/releases/download/v0.10.0/Officer-Kit-Starter-Library.zip) and unzip it into the working folder. It drops fifteen public publications into `Reference/`: MCDP 1, 1-0 and 7, MCRP 3-10A.2, 3-10A.3 and 3-10A.4, MCWP 3-01, MCTP 3-30A, MCO 1610.7B, 1650.19J, 5100.29C, 5215.1K, 5354.1G and 1616.1, and NAVMC 5239.1, with a README that names each one's marines.mil source page. |
