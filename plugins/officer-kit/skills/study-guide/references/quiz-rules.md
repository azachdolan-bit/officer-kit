...
5. **Positions.** The builders place correct answers in a seeded, balanced, unpatterned order (each position within one of a quarter of the questions, no two adjacent questions sharing a position) and shuffle the distractors. Author the answer anywhere.
